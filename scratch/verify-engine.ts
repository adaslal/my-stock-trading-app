import { calculatePAVP } from '../src/pavpEngine';
import { generateHistoricalData, INDIAN_WATCHLIST } from '../src/mockData';

console.log('🧪 Running Aegis PAVP Calculations ES Modules Diagnostics...');
